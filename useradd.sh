...
cn: $USERNAME" \
\
| ldapadd -x -ZZ -h $LDAPHOST -D "$BINDUSER" -W && echo "Success! The $USERNAME account was created. You probably want to run 'ldap-sshkeyadd' next." || echo "FAIL! The $USERNAME account was not created successfully"
